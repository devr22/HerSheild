package org.security.hershield.adapter;
...
public class trusted_person_adapter extends ArrayAdapter<Trusted_person_model> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        name.setText("Name: "+list_member_list.get(position).getName());
        contact.setText("Contact No.: "+list_member_list.get(position).getContact());
        relation.setText("Relationship: "+list_member_list.get(position).getRelation());
        address.setText("Address: "+list_member_list.get(position).getAddress());
        return v;
    }
}
